...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_MY_ALL_REDUCE_COMBINER_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_MY_ALL_REDUCE_COMBINER_H_
...
class MyAllReduceCombiner : public HloModulePass {
 public:
	MyAllReduceCombiner(int64 combine_threshold_in_bytes,
