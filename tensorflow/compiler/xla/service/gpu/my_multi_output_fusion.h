...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_GPU_MY_MULTI_OUTPUT_FUSION_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_GPU_MY_MULTI_OUTPUT_FUSION_H_
...
// GPU backend.
class MyGpuMultiOutputFusion : public HloModulePass {
 public:
	MyGpuMultiOutputFusion() = default;
