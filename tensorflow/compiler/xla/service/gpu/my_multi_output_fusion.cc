...
void MyGpuMultiOutputFusion::RecomputeReachability() {
  reachability_ = HloReachabilityMap::Build(computation_);
}

bool MyGpuMultiOutputFusion::FuseSiblings(HloInstruction* parent) {
...
bool MyGpuMultiOutputFusion::DoMultiOutputFusion() {
  bool changed = false;
  RecomputeReachability();
...
StatusOr<bool> MyGpuMultiOutputFusion::Run(HloModule* module) {
  bool changed = false;
